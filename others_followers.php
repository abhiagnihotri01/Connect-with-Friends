<?php
  ...
  $_SESSION['others_tweets_followers_following']="others_followers.php";
...
<div class="followers_profile1">
    ...
    $query = mysql_query("select * from $_SESSION[others_username]_followers", $con);
    ...
    if($query && ($num=mysql_num_rows($query)) > 0)
    {
      while($row=mysql_fetch_array($query))
      {
	    ...
	    echo "<a href='profile.php' class='follow_unfollow_link1' id='$row[username]'>Following</a>";
