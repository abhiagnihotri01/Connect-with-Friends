<?php
  ...
  $_SESSION['tweets_followers_following']="followers.php";
...
function unfollow_java_func(obj)
{
    var s = obj.getAttribute("id");
        ...
        xmlhttp.open("GET","delete_followers_following_ajax.php?followers="+s,false);
...
<div class="followers_profile1">
    ...
    $query = mysql_query("select * from $_SESSION[username]_followers", $con);
    ...
    if($query && ($num=mysql_num_rows($query)) > 0)
    {
      while($row=mysql_fetch_array($query))
      {
	    ...
	    echo "<a href='profile.php' class='follow_unfollow_link1' id='$row[username]' onmouseover='following_func1(this);' onmouseout='following_func2(this);' onclick='unfollow_java_func(this);'>Following</a>";
